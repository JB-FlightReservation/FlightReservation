...
public class ReservationController {
	...
	// TODO: main 페이지의 예매 페이지와 연동하기
	@PostMapping("/temp.do")
	public String reseravtionInputForm(HttpSession session, @RequestParam(value = "depAprt") String depAprt,
			@RequestParam(value = "landAprt") String landAprt, @RequestParam(value = "depDate") String depDate)
			throws IOException {
...
//        rSession.setRvPhone(rDto.getRvPhone());
	...
	public String baggageInput(PassengerInfoDto pDto,
			/* @SessionAttribute ReservationDto rSession, */ @SessionAttribute PassengerInfoDto pSession) {
